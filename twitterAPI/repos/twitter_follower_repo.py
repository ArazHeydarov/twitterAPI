...
class TwitterFollowersRepo:
    ...
    def fetch_followers_count(self, currently_following):
        return TwitterFollower.objects.filter(user=self.twitter_user,
                                              currently_following=currently_following).count()
